...
public class LogInPageController {
    ...
    private void signUp(ActionEvent event) throws IOException {
        if (v == 1 && (!userNameInput.getText().equals("") && !passwordInput.getText().equals("")
            ...
            FXMLLoader fxmlLoader2 = new FXMLLoader(App.class.getResource("layouts/exceptionForRepeatedData.fxml"));
            Parent parent2 = fxmlLoader2.load();
            Scene scene2 = new Scene(parent2);
            Stage stage = new Stage();
            stage.setScene(scene2);
    ...
    private void signIn(ActionEvent event) throws IOException {
        ...
        if (userNameInput.getText().equals(initUser.username) || userNameInput.getText().equals(user1.username)
                || userNameInput.getText().equals(user2.username)) {
            if (passwordInput.getText().equals(initUser.password) || passwordInput.getText().equals(user1.password)
                    || passwordInput.getText().equals(user2.password)) {
                ...
                FXMLLoader errorFxmlLoader = new FXMLLoader(
                        App.class.getResource("layouts/exceptionForWrongData.fxml"));
            ...
            FXMLLoader errorFxmlLoader = new FXMLLoader(App.class.getResource("layouts/exceptionForWrongData.fxml"));
            Parent errorParent = errorFxmlLoader.load();
            Scene errorScene = new Scene(errorParent);
            Stage stage = new Stage();
            stage.setScene(errorScene);
