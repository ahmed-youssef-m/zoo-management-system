...
// \n"
// + "and India. It has a muscular, broad-chested body; short, rounded head;
// round ears; \n"
// + "and a hairy tuft at the end of its tail. It is sexually dimorphic; adult
// male lions are largers \n";
// }
...
// public String getInfo() {
// return "The info : \n"+
// "is a common name that may refer to most mammals of the infraorder
// Simiiformes,\n" +
// "also known as the simians. Traditionally, all animals in the group now known
// as\n" +
// " simians are counted as monkeys except the apes, which constitutes an
// incomplete\n";
// }
...
// public String getInfo() {
// return "The info : \n"
// + "are African equines with distinctive black-and-white striped coats. There
// are \n"
// + "three living species: the Grévy's zebra (Equus grevyi), plains zebra (E.
// quagga),\n "
// + "and the mountain zebra (E. zebra). Zebras share the genus Equus with
// horses and asses\n ";
// }
...
// + "There are three living species: the Grévy's zebra (Equus grevyi), plains
// zebra \n"
// + "(E. quagga), and the mountain zebra (E. zebra). Zebras share the genus
...
// \n"+
// "tallest living terrestrial animal and the largest ruminant on Earth.
// Traditionally,\n" +
// "giraffes were thought to be one species, Giraffa camelopardalis, with nine
// subspecies. \n";
// }
